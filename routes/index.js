...
// admin only
router.delete('/admin/v1/users/:id', authenticated, isAdmin, (req, res, next) =>
  adminController.deleteUser(req, res, next)
);
router.patch('/admin/v1/users/:id', authenticated, isAdmin, (req, res, next) =>
  adminController.updateUser(req, res, next)
);
router.get('/admin/v1/users/:id', authenticated, isAdmin, (req, res, next) =>
  adminController.getUser(req, res, next)
);
router.post('/admin/v1/users', authenticated, isAdmin, (req, res, next) =>
  adminController.createUser(req, res, next)
);
router.get('/admin/v1/users', authenticated, isAdmin, (req, res, next) =>
  adminController.listUsers(req, res, next)
);

// authenticated users only
router.get('/v1/profile', authenticated, (req, res, next) =>
